...
const buttonVariants = cva(
  'inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-md text-sm font-medium ring-offset-background transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0',
  {
    variants: {
      variant: {
        default:
          'bg-brilliant text-primary-foreground hover:bg-primary/90 w-fit lg:h-11 lg:rounded-md lg:px-8 lg:text-lg sm:h-9 sm:rounded-md sm:px-3',
        destructive:
        ...
        ghost:
          'lg:h-11 lg:rounded-md lg:px-8 lg:text-lg sm:h-9 sm:rounded-md sm:px-3 hover:bg-accent hover:text-accent-foreground w-fit',
        ...
        paginationFirst:
          ' border-2 shadow-sm text-brilliant border-l border-input bg-background hover:bg-accent hover:text-accent-foreground w-fit rounded-l-lg rounded-r-none hover:text-brilliant',
        paginationNext:
          ' border-2 shadow-sm text-brilliant border-r border-input bg-background hover:bg-accent hover:text-accent-foreground w-fit rounded-r-lg rounded-l-none',
        paginationCurrent:
          ' border-2 shadow-sm text-brilliant border-r border-input bg-background hover:bg-accent hover:text-accent-foreground w-fit rounded-none',
        paginationOther:
          ' border-2 shadow-sm text-brilliant bg-brilliant text-brilliant-foreground hover:bg-brilliant/90 w-fit rounded-none',
      },
      size: {
