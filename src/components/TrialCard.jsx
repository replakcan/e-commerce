...
const TrialCard = () => {
    ...
    return (
        <div className="flex flex-col items-center gap-4 py-12 text-center">
            <Heading variant="h2">Start your<br/>14days free trial</Heading>
            <p className="md:w-1/2 text-center w-[80%]">Lorem ipsum dolor sit amet, consectetur adipisicing elit. Accusamus quos, deleniti placeat totam doloribus in. Enim culpa ut cumque blanditiis aspernatur vitae corporis sed quis rem! Amet illum maxime temporibus?</p>
            <div>
