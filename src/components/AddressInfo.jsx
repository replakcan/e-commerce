  ...
  return (
    <div className="border flex justify-between p-2 w-full cursor-pointer p-4 hover:bg-gray-100 hover:shadow-md transition-all duration-200 rounded-lg">
      {isEditing ? (
        ...
        <div className="addressInfo flex flex-col flex-wrap " onClick={onClick}>
          <Heading variant="h2">{title}</Heading>
          <Heading variant="h4">
            {name} {surname}
          </Heading>
          <p>
            <span className="text-danger font-bold">Phone:</span> {phone}
          </p>
          <p>
            <span className="text-danger font-bold">City:</span> {city}
          </p>
          <p>
