    ...
    <form onSubmit={handleSubmit(onSubmit)} className="bg-white shadow-lg rounded-lg p-8 w-full max-w-md mt-4">
      ...
      <div className="mb-4">
        ...
        {(errors.name || errors.surname) && (
          <p className="text-red-500 text-sm">{errors.name?.message || errors.surname?.message}</p>
        )}
      </div>
      ...
      <div className="flex justify-between">
        ...
        <Button
          type="submit"
          className="bg-brilliant text-white py-2 rounded-md hover:black transition duration-300"
        >
          Update Address
        </Button>
      </div>
