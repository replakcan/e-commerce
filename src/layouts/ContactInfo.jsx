    ...
    return (
        <div className="flex flex-col gap-3 md:flex-row md:justify-between py-12">
            <div className="flex flex-col items-center gap-5 md:w-1/2 md:items-start md:justify-center text-center ">
                ...
                <Heading className="md:text-left" variant="h1">Get in touch <br /> today!</Heading>
                <p className="md:w-2/3 w-[60%] md:text-left">We know how large objects will act, but things on a small scale just do not act that way.</p>
