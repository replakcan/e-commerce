...
const SignUp = () => {
  ...
  return (
    <div className="flex justify-center items-center min-h-lvh">
      <form onSubmit={handleSubmit(onSubmit)} className="my-12 max-w-lg mx-auto p-6 bg-white shadow-lg rounded-lg ">
            ...
            <div className="mb-4">
              ...
              <input
                ...
                {...register('storeTaxId', {
                  ...
                  pattern: {
                    value: /^T\d{4}V\d{6}$/,
                    message: 'Tax ID should follow the pattern TXXXXVXXXXXX where X is a number',
                  },
                })}
              />
              {errors.storeTaxId && <p className="text-red-500 text-sm">{errors.storeTaxId.message}</p>}
            </div>
