...
const AboutContext = () => {
    ...
    return (
        <div className="flex flex-col gap-24">
            <div className="flex flex-col items-center text-center md:flex-row gap-8 px-[10%]">
            ...
            <div className="flex flex-col text-center gap-32 md:flex-row md:justify-between">
                <div>
