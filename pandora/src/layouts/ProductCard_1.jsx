...
const ProductCard_1 = () => {
    ...
    return (
        ...
        <div className="productCard flex flex-col md:grid md:grid-cols-3 md:grid-rows-[min-content_1fr]">
            ...
            <nav className="productNav flex flex-col items-center md:col-start-2 col-end-4 md:row-span-1 md:flex-row md:justify-between md:px-7 md:py-6 border-b-1 border-blue-500 gap-6 pt-24">
