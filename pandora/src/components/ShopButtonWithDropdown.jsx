                ...
                >
                    <div>
                        ...
                        <ul className="flex flex-col">
                            {categories.map((cat, index) => {
                                if (cat.gender === "k") {
                                    return <Link key={index} to={`/shop/kadin/${cat.code.slice(2)}/${cat.id}`} className="cursor-pointer">{cat.title}</Link>
                                }
                            })}
                        </ul>
                    </div>
                    <div>
                        ...
                        <ul className="flex flex-col">
                            {categories.map((cat, index) => {
                                if (cat.gender === "e") {
                                    return <Link key={index} to={`/shop/erkek/${cat.code.slice(2)}/${cat.id}`} className="cursor-pointer">{cat.title}</Link>
                                }
                            })}
                        </ul>
                    </div>
